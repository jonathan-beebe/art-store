# Runs without Rails: ruby -Iapp app/domain/reports/listing_status_tally_test.rb
require "minitest/autorun"
require_relative "listing_status_tally"

module Domain
  module Reports
    class ListingStatusTallyTest < Minitest::Test
