...
module Listings
  class CreateListingTest < ActiveSupport::TestCase
    test "a new listing starts as a draft" do
      created = CreateListing.new.call(seller: create_seller, draft: draft)
    ...
    test "a title another listing already slugged is numbered" do
      CreateListing.new.call(seller: create_seller, draft: draft)
    ...
    test "it attaches an uploaded image" do
      created = CreateListing.new.call(seller: create_seller, draft: draft, image: uploaded_image)
