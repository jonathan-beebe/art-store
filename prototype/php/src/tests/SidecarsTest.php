...
it('gives every class under app a sidecar test', function (): void {
    $exceptions = [
        ...
        'app/Domain/Orders/ShippingAddress.php' => null,
        'app/Domain/Reports/ListingStatusCount.php' => null,
        'app/Http/Requests/Seller/ListingRequest.php' => null,
        'app/Http/Requests/Seller/MarkShippedRequest.php' => null,
        'app/Models/Cart.php' => null,
        'app/Models/CartItem.php' => null,
        'app/Models/CustomerMerge.php' => null,
        'app/Models/Favorite.php' => null,
        'app/Models/Fulfillment.php' => null,
        'app/Models/LedgerEntry.php' => null,
        'app/Models/ListingEvent.php' => null,
        'app/Models/Notification.php' => null,
        'app/Models/Order.php' => null,
        'app/Models/OrderItem.php' => null,
        'app/Models/Payment.php' => null,
