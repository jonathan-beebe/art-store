...
/**
 * The one walk this file carries: the whole product's backbone over HTTP,
 * from an empty database to a seller's payout. Every step drives a real
 * route and asserts both the database row it wrote and the page the person
 * would be looking at.
 *
 ...
 *
 * The configurator walks live in ConfiguratorSmokeTest.php instead.
 */
