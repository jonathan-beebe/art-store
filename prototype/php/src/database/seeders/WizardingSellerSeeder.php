...
class WizardingSellerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($this->sellers() as $entry) {
            ...
            foreach ($entry['listings'] as $listing) {
                $createListing($seller, ListingDraft::of(
                    $listing['title'],
                    $listing['description'],
                    $listing['medium'],
                    $listing['dimensions'],
    ...
    /**
     * @return list<array{email: string, name: string, shop_name: string, listings: list<array{title: string, medium: string, dimensions: string, price_cents: int, quantity: int, description: string}>}>
     */
    private function sellers(): array
    {
        return [
            [
                ...
                'listings' => [
                    $this->listing('Mimbulus Mimbletonia, Potted', 'plant', '8 x 5 x 5 in', 9500, 1,
                    ...
                    $this->listing('Flitterbloom Cutting, Rooted', 'plant', '12 in tendrils', 4500, 3,
                    ...
                    $this->listing('Puffapod Seed Collection', 'plant', 'tin of 20 pods', 2500, 6,
                    ...
                    $this->listing('Bouncing Bulb, Established', 'plant', '10 x 7 x 7 in', 6000, 1,
            ...
            [
                ...
                'listings' => [
                    $this->listing('The Quibbler, Back-Issue Bundle', 'publication', '8.5 x 11 in, set of 5', 1200, 12,
                    ...
                    $this->listing('Spectrespecs', 'curio', '6 x 2 x 1 in', 3500, 5,
                    ...
                    $this->listing('Butterbeer Cork Necklace', 'jewelry', '18 in cord', 1800, 4,
                    ...
                    $this->listing('Dirigible Plum Earrings', 'jewelry', '2 in drop', 2200, 3,
    ...
    /**
     * @return array{title: string, medium: string, dimensions: string, price_cents: int, quantity: int, description: string}
     */
