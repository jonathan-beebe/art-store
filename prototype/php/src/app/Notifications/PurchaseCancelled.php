...
/**
 * Tells a customer the order they never paid for has been cancelled — by
 * them, by an admin, or by the stale sweep.
 */
final class PurchaseCancelled extends PrefixedUlidNotification
{
    ...
    {
        return NotificationMessage::purchaseCancelled($this->orderId);
    }
}
