...
it('stores the subject, body, and url of the message', function (): void {
    ...
    expect((new ItemSold('ord_00000000000000000000000004', Money::fromCents(9000)))->toArray($seller))
        ->toBe(NotificationMessage::itemSold('ord_00000000000000000000000004', Money::fromCents(9000))->toArray());
});
