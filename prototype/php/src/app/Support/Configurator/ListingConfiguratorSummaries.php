...
final class ListingConfiguratorSummaries
{
    ...
    /**
     * @return null|array{axes: list<array{name: string, displayedLabels: list<string>, priceDeltas: list<string>, moreCount: int}>, offeredCount: int, totalCombinations: int, lowStockCount: int, combinationsUrl: string}
     */
    public static function choices(Listing $listing): ?array
    {
        ...
        foreach ($axes as $axis) {
            ...
            $axisLines[] = [
                ...
                'priceDeltas' => array_values($displayed
