...
final class ConfiguratorSectionNav
{
    ...
    public static function sections(): array
    {
        return [
            ...
            ['label' => 'Variants', 'route' => 'seller.listings.variants.index', 'pattern' => 'seller.listings.variants.*', 'issueCodes' => ['variant_priced_negative', 'variant_missing_axis_value', 'too_many_variants', 'serialized_variant_has_no_units']],
