...
/**
 * `/admin/analytics/channels/{key}`'s query parameters — docs/alignment.md
...
final class AnalyticsChannelVisitsQueryRequest extends FormRequest
{
     ...
     * rules above as a value they would have to admit. */
    ...
    /** The submitted filters, without `page` — the shape the range
     * segmented control and the pager round-trip.
     *
