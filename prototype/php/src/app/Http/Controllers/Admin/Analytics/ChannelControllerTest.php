 ...
 */
function bindChannelControllerSession(string $sessionId): void
{
...
it('renders 200 with visitors, views, cart adds, and orders per channel, ordered by visitors', function (): void {
...
it('renders the channels page on a fixed number of queries however many channels the range holds', function (): void {
    $listing = $this->listing($this->seller());
    $customer = $this->verifiedCustomer();
    $analytics = app(Analytics::class);
