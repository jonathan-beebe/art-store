 ...
 * PHP over the already-aggregated list rather than in SQL, since the
 * number of distinct actors in a range stays small enough at this
 * prototype's scale that sorting and slicing the whole list in memory
