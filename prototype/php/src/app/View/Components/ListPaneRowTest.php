...
function seedPanePages(CommerceTestCase $test): array
{
    ...
    // The admin inbox's default filter is its needs-reply queue
    // (MessagesQueryRequest), so each conversation needs an unread message
    // to land on the unfiltered index page these tests render.
