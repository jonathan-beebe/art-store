<x-layouts.seller-focused :listing="$listing" :title="'Questions & answers — '.$listing->title.' — Art Store seller'">
    ...
    @if ($faqs->isEmpty())
        <p class="mt-4 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 p-4 text-gray-600 dark:text-gray-400">Nothing published yet. Publish an answer from a message thread about this listing.</p>
    @else
