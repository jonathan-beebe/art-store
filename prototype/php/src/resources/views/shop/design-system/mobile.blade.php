<section id="mobile" class="mt-16 scroll-mt-8" aria-labelledby="mobile-heading">
    ...
    <dl class="mt-6 grid max-w-2xl gap-x-8 gap-y-2 rounded-card border border-line bg-surface p-5 text-sm sm:grid-cols-[auto_1fr]">
        ...
        <dd class="text-ink-muted">2-up grid, sheet pickers, the browse sheet</dd>
    ...
    <div class="mt-8 grid gap-8 lg:grid-cols-2">
        <div>
            <h3 class="text-xs font-semibold text-ink-muted">Browse media as a bottom sheet <span class="font-normal text-ink-faint">— <code class="font-mono text-[11px]">media-gallery-panel</code>, the shipped pattern; tap the pill inside the frame</span></h3>
        ...
        <div>
            <h3 class="text-xs font-semibold text-ink-muted">Cover-card rail <span class="font-normal text-ink-faint">— <code class="font-mono text-[11px]">media-cover-rail</code>, an exploration the product does not currently wear; one row, flick to browse, snap to seat</span></h3>
            <div class="mt-3 w-fit overflow-hidden rounded-[1.75rem] border-4 border-line-strong bg-surface p-1">
        ...
        <div>
            <h3 class="text-xs font-semibold text-ink-muted">Sticky buy bar <span class="font-normal text-ink-faint">— an exploration the product does not currently wear; listing price and action pinned to the bottom edge, scroll the frame</span></h3>
            <div class="mt-3 w-fit overflow-hidden rounded-[1.75rem] border-4 border-line-strong bg-surface p-1">
        ...
        <div>
            <h3 class="text-xs font-semibold text-ink-muted">Swipe gallery <span class="font-normal text-ink-faint">— an exploration the product does not currently wear; listing photos as a scroll-snap carousel, swipe inside the frame</span></h3>
            <div class="mt-3 w-fit overflow-hidden rounded-[1.75rem] border-4 border-line-strong bg-surface p-1">
