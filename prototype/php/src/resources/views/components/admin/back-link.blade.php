...
<a href="{{ $route }}" class="mb-2 inline-flex min-h-11 items-center gap-1.5 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 sm:hidden">
