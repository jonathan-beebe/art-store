<x-layouts.admin title="Fulfillments — Art Store admin" mode="list" empty-detail-prompt="Choose a fulfillment to see its details.">
    <x-slot:cells>
        <div class="flex items-baseline gap-2 border-b border-stone-200 px-6 py-4 dark:border-white/10">
            ...
            <span class="text-xs text-stone-500 dark:text-stone-400">{{ $fulfillmentsTotal }}</span>
        </div>
    ...
    <h1 class="text-xl font-semibold text-stone-900 dark:text-stone-100">Fulfillments</h1>
