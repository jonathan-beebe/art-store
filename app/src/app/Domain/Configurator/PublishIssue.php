 ...
 * first. `subjectId` names the row the issue is about (a variant's id, for
 * example) when there is one, so the seller-facing screen can link straight
 * to it instead of the general screen that owns its kind of issue.
 */
