 ...
 * docs/spec.md §2.1, the same object in every environment.
 *
...
final readonly class StoryFormatter implements FormatterInterface
{
    ...
    /** docs/spec.md §2.4: derived from the line's level and phase in
     ...
     * person reading plain stdout (docs/spec.md §2.4): every `warn`
     ...
     * that has something to say (docs/spec.md §2.1).
     *
     * @param  array<mixed>  $context
