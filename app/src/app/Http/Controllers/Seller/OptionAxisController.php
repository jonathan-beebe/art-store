...
final class OptionAxisController extends SellerController
{
    ...
    public function store(
        ...
        // before the choice is put to use. The pricing mode says whether the
        // catalog has anything to offer; the axis keeps its catalog link
        // (still searchable) either way.
        if ($property !== null && $axis->pricing_mode->acceptsCatalogPrefill()) {
