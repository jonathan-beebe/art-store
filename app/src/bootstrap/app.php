...
use App\Console\Commands\Sweep\SweepCustomers;
...
$app = Application::configure(basePath: dirname(__DIR__))
    ...
    // class's docblock.
    ->withCommands([RunWeeklyPayouts::class, SweepOrders::class, SweepLogs::class, SweepAnalytics::class, SweepCustomers::class, SeedActivity::class, MintMcpKey::class])
    ->withRouting(
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        // docs/spec.md §3: the client ip is the socket's own unless an
    ...
    ->withExceptions(function (Exceptions $exceptions): void {
        ...
        // docs/spec.md §3's default 429: the site's own page, in its own
